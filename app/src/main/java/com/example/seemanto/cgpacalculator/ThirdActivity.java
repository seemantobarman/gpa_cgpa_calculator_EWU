...
public class ThirdActivity extends AppCompatActivity {
    ...
    String[] grades;
    private Spinner first_spinner,second_spinner,third_spinner;
    private EditText first_edittext,second_edittext,third_edittext;
    private Button calculate_button,cgpa_calculate;
    private TextView result_textview;
    double first_grade_point,second_grade_point,third_grade_point;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ArrayAdapter<String> first_adapter = new ArrayAdapter<String> (ThirdActivity.this,R.layout.sample_spinner_view,R.id.samplespinnerviewID,grades);
        ...
        try
            {
                ...
                if ( credit_1>4 || credit_1<1 || credit_2>4 || credit_2<1 || credit_3>4 || credit_3<1 )
                    {
                    ...
                    {
                        double sumofcredit = credit_1 + credit_2 + credit_3;
                        double sum = (credit_1*first_grade_point) + (credit_2*second_grade_point) + (credit_3*third_grade_point);
