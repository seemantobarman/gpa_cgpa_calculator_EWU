...
public class FifthActivity extends AppCompatActivity {
    ...
    String[] grades;
    private Spinner first_spinner,second_spinner,third_spinner,fourth_spinner,fifth_spinner;
    private EditText first_edittext,second_edittext,third_edittext,fourth_edittext,fifth_edittext;
    private Button calculate_button,cgpa_calculate;
    private TextView result_textview;
    double first_grade_point,second_grade_point,third_grade_point,fourth_grade_point,fifth_grade_point;
...

    {
        ...
        fifth_edittext = findViewById(R.id.third_activity_edittext5ID);
        ...
        fifth_spinner = findViewById(R.id.fifth_spinnerID);
        ...
        fifth_spinner.setAdapter(first_adapter);
    ...
    public void third_process(View view)
    {
        ...
        String fifth_grade = fifth_spinner.getSelectedItem().toString();

        if(fifth_grade.equals("A")){
        ...
        if(fifth_grade.equals("A-")){
            ...
            fifth_grade_point = 3.70;
        }

        if (fifth_grade.equals("B+")){

            fifth_grade_point = 3.30;
        }
        ...
        if(fifth_grade.equals("B-")){
            ...
            fifth_grade_point = 2.70;
        }

        if (fifth_grade.equals("C+")){

            fifth_grade_point =2.30;
        }
        ...
        if(fifth_grade.equals("C-")){
            ...
            fifth_grade_point = 1.70;
        }

        if (fifth_grade.equals("D+")){

            fifth_grade_point = 1.30;
        }
        ...
        try
        {
            ...
            String fifth_credit = fifth_edittext.getText().toString();
            ...
            double credit_5 = Double.parseDouble(fifth_credit);

            if ( credit_1>4 || credit_1<1 || credit_2>4 || credit_2<1 || credit_3>4 || credit_3<1 || credit_4>4 || credit_4<1 || credit_5>4 || credit_5<1)
            {
            ...
            {
                double sumofcredit = credit_1 + credit_2 + credit_3 + credit_4 + credit_5;
                double sum = (credit_1*first_grade_point) + (credit_2*second_grade_point) + (credit_3*third_grade_point) + (credit_4*fourth_grade_point) + (credit_5*fifth_grade_point);
